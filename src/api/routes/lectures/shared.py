...
from ...common import ensure_lecture_access, get_lecture_or_404, lecture_to_response
from ...models import UploadResponse
from ...upload_config import AUDIO_EXTENSIONS, DOCUMENT_EXTENSIONS, MAX_FILE_SIZE, SLIDE_EXTENSIONS
