...
from ...models import CourseListResponse, CourseQueryRequest, QueryResponse
...
async def join_course_by_code(payload: dict, current_user: dict = Depends(get_current_user)):
