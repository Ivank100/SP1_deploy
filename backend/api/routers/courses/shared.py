...
from ...schemas import CourseResponse, UploadRequestResponse
from ...services.responses import lecture_to_response, upload_request_to_response
from ...services.uploads import AUDIO_EXTENSIONS, MAX_FILE_SIZE, PDF_EXTENSIONS, SLIDE_EXTENSIONS
